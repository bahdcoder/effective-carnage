import { IgnitorCli } from "@/server/ignitor/ignitor-cli.js"
import { resolve } from "@/utils/container/resolve.js"
import { command } from "@drizzle-team/brocli"
import { Prisma } from "@prisma/client"

/**
 * Provides a CLI command to seed the database with sample sports events.
 * Useful for development and testing environments to quickly populate
 * the database with realistic data.
 */
